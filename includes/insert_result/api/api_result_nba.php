...
<br>
		...
		<input type="text" name="valeur_result_nba" id="valeur_result_nba" value="<?php echo $_SESSION["valeur_result_nba"]; ?>">

    <form action="api_result_nba.php" method="post">
    ...
    <?php require_once '../new/new_result_nba.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
    <script src="../insert/insert_result_nba.js"></script>
</body>
