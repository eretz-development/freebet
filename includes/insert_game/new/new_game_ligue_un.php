<?php
	...
	([
		...
		$_SESSION['valeur_match_ligue_un'] = $_SESSION['valeur_match_ligue_un'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_ligue_un.php"><?php

		if ($_SESSION['valeur_match_ligue_un'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
