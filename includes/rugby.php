...
<html lang="fr" dir="ltr">
	...
	<main>
		<?php
			$six_nations = $db->prepare("SELECT * FROM game WHERE sport = :sport AND ligue = :ligue LIMIT 20");
			$six_nations->execute([
				'sport' => 'rugby',
				'ligue' => 'Six Nations'
			]);
			$six_nations_match = $six_nations->rowCount();

			if(isset($_POST['filter_submit'])){

				extract($_POST);

				if($_POST['filter_select'] == 'Tournoi des 6 nations'){
		...
		<div class='side_nav'>
			...
			<div class="container">
				...
				<button class="btn-5" onclick="filter_select_2()"><span class="btn-filtre" id="btn_filtre_2">Tournoi des 6 nations</span> <span class="nb-matchs"><?php echo $six_nations_match." matchs"; ?></span> </button>
			</div>

			<form action="rugby.php" method="post">
	...
	margin:0px;
	padding:0px;
    background-image: url("../img/alex-motoc-5A8kD7pmY38-unsplash.jpg");
