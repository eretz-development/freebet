<?php
    ...
    if ($result == 0) {
      ...
      'score_equipe_une' => $_POST['home_team_result'],
		...
		$_SESSION['valeur_match'] = $_SESSION['valeur_match'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/api_result.php"><?php

		if ($_SESSION['valeur_match'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/Project_SD/index.php"><?php
		}
