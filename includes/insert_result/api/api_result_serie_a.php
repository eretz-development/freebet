...
<br>
		...
		<input type="text" name="valeur_result_serie_a" id="valeur_result_serie_a" value="<?php echo $_SESSION["valeur_result_serie_a"]; ?>">

    <form action="api_result_serie_a.php" method="post">
