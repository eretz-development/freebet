...
<br>
		...
		<input type="text" name="valeur_match_six_nations" id="valeur_match_six_nations" value="<?php echo $_SESSION["valeur_match_six_nations"]; ?>">

    <form action="api_game_six_nations.php" method="post">
    ...
    <?php require_once '../new/new_game_six_nations.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_game.js"></script>
    <script src="../insert/insert_game_six_nations.js"></script>
</body>
