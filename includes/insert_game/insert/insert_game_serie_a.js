//////api test Inumerique2307@ : https://api.the-odds-api.com/v3/odds/?sport=soccer_italy_serie_a&region=us&apiKey=e10a7584bdff7319e5acbb974c974daf
...
function liste_match_foot(data){
  ...
  if (obj.data[0].sport_key == 'soccer_italy_serie_a') {
    var sport = 'foot';
  }

    var valeur_match = document.getElementById("valeur_match_serie_a").value ;
