...
<br>
		...
		<input type="text" name="valeur_result_euroleague" id="valeur_result_euroleague" value="<?php echo $_SESSION["valeur_result_euroleague"]; ?>">

    <form action="api_result_euroleague.php" method="post">
    ...
    <?php require_once '../new/new_result_euroleague.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_result.js"></script>
    <script src="../insert/insert_result_euroleague.js"></script>
