...
<br>
		...
		<input type="text" name="valeur_result_ligue_un" id="valeur_result_ligue_un" value="<?php echo $_SESSION["valeur_result_ligue_un"]; ?>">

    <form action="api_result_ligue_un.php" method="post">
    ...
    <?php require_once '../new/new_result_ligue_un.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_result.js"></script>
    <script src="../insert/insert_result_ligue_un.js"></script>
</body>
