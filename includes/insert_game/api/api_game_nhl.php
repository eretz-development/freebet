...
<br>
		...
		<input type="text" name="valeur_match_nhl" id="valeur_match_nhl" value="<?php echo $_SESSION["valeur_match_nhl"]; ?>">

    <form action="api_game_nhl.php" method="post">
    ...
    <?php require_once '../new/new_game_nhl.php' ?>
