<?php
	...
	([
		...
		$_SESSION['valeur_match_ncaab'] = $_SESSION['valeur_match_ncaab'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_ncaab.php"><?php

		if ($_SESSION['valeur_match_ncaab'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
