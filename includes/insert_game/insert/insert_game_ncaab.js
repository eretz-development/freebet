//////api test Inumerique2307@ : https://api.the-odds-api.com/v3/odds/?sport=basketball_ncaab&region=us&apiKey=e10a7584bdff7319e5acbb974c974daf
...
function liste_match_basket(data){
  ...
  if (obj.data[0].sport_key == 'basketball_ncaab') {
    var sport = 'basket';
  }

  var valeur_match = document.getElementById("valeur_match_ncaab").value ;
