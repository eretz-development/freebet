...
<br>
		...
		<input type="text" name="valeur_match_uefa_europa_league" id="valeur_match_uefa_europa_league" value="<?php echo $_SESSION["valeur_match_uefa_europa_league"]; ?>">

    <form action="api_game_uefa_europa_league.php" method="post">
    ...
    <?php require_once '../new/new_game_uefa_europa_league.php' ?>
