...
function liste_result_foot(data){
  ...
  var valeur_result_premier_league = document.getElementById("valeur_result_premier_league").value;
  console.log(valeur_result_premier_league);

  var id = obj.teams[valeur_result_premier_league].idTeam;
