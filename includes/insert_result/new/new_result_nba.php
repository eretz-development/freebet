<?php
    ...
    $a = $db->prepare("SELECT * FROM result WHERE equipe_une = :equipe_une AND equipe_deux = :equipe_deux");
    $a->execute([
    ...
    if ($result == 0) {
      ...
      'score_equipe_une' => $_POST['home_team_result'],
		...
		$_SESSION['valeur_result_nba'] = $_SESSION['valeur_result_nba'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_result/api/api_result_nba.php"><?php

		if ($_SESSION['valeur_result_nba'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
