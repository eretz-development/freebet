<?php
	...
	([
		...
		$_SESSION['valeur_match_euroleague'] = $_SESSION['valeur_match_euroleague'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_euroleague.php"><?php

		if ($_SESSION['valeur_match_euroleague'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
