<?php
    ...
    if ($result == 0) {
      ...
      'score_equipe_une' => $_POST['home_team_result'],
		...
		$_SESSION['valeur_result_bundesliga'] = $_SESSION['valeur_result_bundesliga'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_result/api/api_result_bundesliga.php"><?php

		if ($_SESSION['valeur_result_bundesliga'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
