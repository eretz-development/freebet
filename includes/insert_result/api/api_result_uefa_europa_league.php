...
<br>
		...
		<input type="text" name="valeur_result_uefa_europa_league" id="valeur_result_uefa_europa_league" value="<?php echo $_SESSION["valeur_result_uefa_europa_league"]; ?>">

    <form action="api_result_uefa_europa_league.php" method="post">
    ...
    <?php require_once '../new/new_result_uefa_europa_league.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_result.js"></script>
    <script src="../insert/insert_result_uefa_europa_league.js"></script>
</body>
