<?php
	...
	([
		...
		$_SESSION['valeur_match_premier_league'] = $_SESSION['valeur_match_premier_league'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_premier_league.php"><?php

		if ($_SESSION['valeur_match_premier_league'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
