...
<br>
		...
		<input type="text" name="valeur_match_uefa_champions_league" id="valeur_match_uefa_champions_league" value="<?php echo $_SESSION["valeur_match_uefa_champions_league"]; ?>">

    <form action="api_game_uefa_champions_league.php" method="post">
    ...
    <?php require_once '../new/new_game_uefa_champions_league.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_game.js"></script>
    <script src="../insert/insert_game_uefa_champions_league.js"></script>
</body>
