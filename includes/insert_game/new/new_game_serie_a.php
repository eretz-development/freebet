<?php
	...
	([
		...
		$_SESSION['valeur_match_serie_a'] = $_SESSION['valeur_match_serie_a'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_serie_a.php"><?php

		if ($_SESSION['valeur_match_serie_a'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
