...
<br>
		...
		<input type="text" name="valeur_result_premier_league" id="valeur_result_premier_league" value="<?php echo $_SESSION["valeur_result_premier_league"]; ?>">

    <form action="api_result_premier_league.php" method="post">
    ...
    <?php require_once '../new/new_result_premier_league.php' ?>
