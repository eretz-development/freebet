...
<html lang="fr" dir="ltr">
	...
	<div class='side_nav'>
					...
					<div class="container">
						<button class="btn-5"><span class="btn-filtre" id="btn_filtre_1" onclick="filter_select_1()">Tournoi des 6 nations</span> <span class="nb-matchs"><?php echo $six_nations_match." matchs"; ?></span> </button>
					</div>
