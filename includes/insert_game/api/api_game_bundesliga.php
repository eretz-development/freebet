...
<br>
		...
		<input type="text" name="valeur_match_bundesliga" id="valeur_match_bundesliga" value="<?php echo $_SESSION["valeur_match_bundesliga"]; ?>">

    <form action="api_game_bundesliga.php" method="post">
    ...
    <?php require_once '../new/new_game_bundesliga.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_game.js"></script>
    <script src="../insert/insert_game_bundesliga.js"></script>
</body>
