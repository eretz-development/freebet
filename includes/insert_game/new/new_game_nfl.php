<?php
	...
	([
		...
		$_SESSION['valeur_match_nfl'] = $_SESSION['valeur_match_nfl'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_nfl.php"><?php

		if ($_SESSION['valeur_match_nfl'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
