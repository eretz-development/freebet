...
<br>
		...
		<input type="text" name="valeur_match_la_liga" id="valeur_match_la_liga" value="<?php echo $_SESSION["valeur_match_la_liga"]; ?>">

    <form action="api_game_la_liga.php" method="post">
    ...
    <?php require_once '../new/new_game_la_liga.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
		<script src="../modify_name_game.js"></script>
    <script src="../insert/insert_game_la_liga.js"></script>
</body>
