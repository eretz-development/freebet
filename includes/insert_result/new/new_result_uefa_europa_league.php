<?php
    ...
    if ($result == 0) {
      ...
      'score_equipe_une' => $_POST['home_team_result'],
		...
		$_SESSION['valeur_result_uefa_europa_league'] = $_SESSION['valeur_result_uefa_europa_league'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_result/api/api_result_uefa_europa_league.php"><?php

		if ($_SESSION['valeur_result_uefa_europa_league'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
