//////api test Inumerique2307@ : https://api.the-odds-api.com/v3/odds/?sport=americanfootball_nfl&region=us&apiKey=e10a7584bdff7319e5acbb974c974daf
...
function liste_match_footam(data){
  ...
  if (obj.data[0].sport_key == 'americanfootball_nfl') {
    ...
    var valeur_match = document.getElementById("valeur_match_nfl").value ;
