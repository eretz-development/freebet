...
<br>
		...
		<input type="text" name="valeur_match_nba" id="valeur_match_nba" value="<?php echo $_SESSION["valeur_match_nba"]; ?>">

    <form action="api_game_nba.php" method="post">
    ...
    <?php require_once '../new/new_game_nba.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
    <script src="../insert/insert_game_nba.js"></script>
</body>
