...
<br>
		...
		<input type="text" name="valeur_match_ncaab" id="valeur_match_ncaab" value="<?php echo $_SESSION["valeur_match_ncaab"]; ?>">

    <form action="api_game_ncaab.php" method="post">
    ...
    <?php require_once '../new/new_game_ncaab.php' ?>

    <script src="../../jquery-3.4.1.js"></script>
    <script src="../../ajax.js"></script>
    <script src="../insert/insert_game_ncaab.js"></script>
</body>
