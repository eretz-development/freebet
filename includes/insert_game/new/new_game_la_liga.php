<?php
	...
	([
		...
		$_SESSION['valeur_match_la_liga'] = $_SESSION['valeur_match_la_liga'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_la_liga.php"><?php

		if ($_SESSION['valeur_match_la_liga'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
