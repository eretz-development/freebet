<?php
	...
	([
		...
		$_SESSION['valeur_match_bundesliga'] = $_SESSION['valeur_match_bundesliga'] + 1 ;
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		?><meta http-equiv="refresh" content="0.0001;URL=/freebet/includes/insert_game/api/api_game_bundesliga.php"><?php

		if ($_SESSION['valeur_match_bundesliga'] == 150) {
			?><meta http-equiv="refresh" content="0.0001;URL=/freebet/index.php"><?php
		}
